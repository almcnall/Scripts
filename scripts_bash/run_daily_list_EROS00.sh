...
exp_num='EXP006' #dealing with output from which exp?
 ...
 for year in {2002..2010};do #years in exp
   #cd /gibber/lis_data/RFE2_UMDVeg/output/$exp_num/NOAH32/$year
    ...
    for i in $( ls );do #look at the list
      ...
      echo "daily_total_gs4r_theo2,\" $year\", \" $date\",\"$exp_num\", $nx,$ny,$nbands " >> /home/source/mcnally/scripts_idl/$out_file #write to file
