...
exp_num='EXPA02' #dealing with output from which exp?
...
echo 'pro run_daily_'$v'' > /home/source/mcnally/scripts_idl/$out_file #first line of script
 ...
 for year in {2009..2011};do #years in exp
   #cd /gibber/lis_data/RFE2_UMDVeg/output/$exp_num/NOAH32/$year
    ...
    for i in $( ls );do #look at the list
      ...
      echo "daily_total_gs4r_niger,\" $year\", \" $date\",\"$exp_num\", $nx,$ny,$nbands " >> /home/source/mcnally/scripts_idl/$out_file #write to file
