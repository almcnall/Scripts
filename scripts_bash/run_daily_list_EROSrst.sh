...
exp_num='EXP000' #dealing with output from which exp?
...
echo 'pro run_daily_'$v'' > /home/source/mcnally/scripts_idl/$out_file #first line of script
 ...
 for year in {2007..2010};do #years in exp
   #cd /gibber/lis_data/RFE2_UMDVeg/output/$exp_num/NOAH32/$year
    ...
    for i in $( ls );do #look at the list
      ...
      echo "daily_total_gs4r_theo,\" $year\", \" $date\",\"$exp_num\", $nx,$ny,$nbands " >> /home/source/mcnally/scripts_idl/$out_file #write to file
