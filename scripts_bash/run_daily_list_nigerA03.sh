...
exp_num='EXPA03' #dealing with output from which exp?
nx=17           #the more i can put in this bash file the less will need to be replicated between idl scripts 
ny=12
nbands=32
...
echo 'pro run_daily_'$v'' > /home/source/mcnally/scripts_idl/$out_file #first line of script
 ...
 for year in {2002..2009};do #years in exp
   #cd /gibber/lis_data/RFE2_UMDVeg/output/$exp_num/NOAH32/$year
    ...
    for i in $( ls );do #look at the list
      ...
      echo "daily_total_gs4r_A03,\" $year\", \" $date\",\"$exp_num\", $nx,$ny,$nbands " >> /home/source/mcnally/scripts_idl/$out_file #write to file
