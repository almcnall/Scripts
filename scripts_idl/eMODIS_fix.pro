...
;this script is to fix the west africa window so that it is consistant eMODIS with the shift.
;i need to check out the data that greg modified to see if it was chopped properly>>>
;
...
;there is a 3.475 degree shift according to ENVI where the N is 17.52500000 (really?) vs 21.
...
year = ['2009','2010','2011'] ; crashed after 2008 so restarting 1/18
...
;for i = 0,n_elements(year)-1 do begin
  ifile = file_search('data.{2009,2010,2011}*.tiff')
