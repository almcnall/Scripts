...
;SSRUN_GDS0_SFC_ave4h:long_name = "Surface runoff (non-infiltrating)" ; 
;SSRUN_GDS0_SFC_ave4h:units = "Kg/m^2" ;

;BGRUN_GDS0_SFC_ave4h:long_name = "Subsurface runoff (baseflow)" ;
;BGRUN_GDS0_SFC_ave4h:units = "Kg/m^2" ;
...
odir = strcompress('/jabber/sandbox/mcnally/VIC_runoff/binary/', /remove_all)
cd, indir
...
;open the file
  ...
  runoffID = ncdf_varid(fileID,'SSRUN_GDS0_SFC_ave4h');I know the name from using some other functions, ncdump is prolly best
