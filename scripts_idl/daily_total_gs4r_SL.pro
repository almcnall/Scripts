pro daily_total_gs4r_SL,year,date,expdir,nx,ny,nbands
...
flip_AF_gs4r_SL,date,year,expdir,nx,ny,nbands
...
of14 = strcompress(day_file+"sm05_" +date+".img",/remove_all)
of15 = strcompress(day_file+"sm06_" +date+".img",/remove_all)
of16 = strcompress(day_file+"PoET_" +date+".img",/remove_all)
of17 = strcompress(day_file+"ECan_" +date+".img",/remove_all)
of18 = strcompress(day_file+"TVeg_" +date+".img",/remove_all)
of19 = strcompress(day_file+"ESol_" +date+".img",/remove_all)
of20 = strcompress(day_file+"rain_" +date+".img",/remove_all)
of21= strcompress(day_file+"SWIx_" +date+".img",/remove_all)
of22 = strcompress(day_file+"WRTS_" +date+".img",/remove_all)
of23 = strcompress(day_file+"wAET_" +date+".img",/remove_all)
of24= strcompress(day_file+"WRSI_" +date+".img",/remove_all)
of25= strcompress(day_file+"xtSM_" +date+".img",/remove_all)
...
sm05= mean(data_in[*,*,13,*],/NAN, dimension=4) 
sm06= mean(data_in[*,*,14,*],/NAN, dimension=4) ;added these two in shifing everything down by 2!
PoET= mean(data_in[*,*,15,*],/NAN, dimension=4) 
Ecan= mean(data_in[*,*,16,*],/NAN, dimension=4) 
Tveg= mean(data_in[*,*,17,*],/NAN, dimension=4) 
Esol= mean(data_in[*,*,18,*],/NAN, dimension=4) 
rain= mean(data_in[*,*,19,*],/NAN, dimension=4) 
SWIx= mean(data_in[*,*,20,*],/NAN, dimension=4) 
WRTS= mean(data_in[*,*,21,*],/NAN, dimension=4) 
wAET= mean(data_in[*,*,22,*],/NAN, dimension=4) 
WRSI= mean(data_in[*,*,23,*],/NAN, dimension=4) 
xtSM= mean(data_in[*,*,24,*],/NAN, dimension=4) 
...
writeu,12, sm03
writeu,13, sm04
writeu,14, sm05 ;added these two in late....
writeu,15, sm06 ;added these two in late....
writeu,16, PoET
writeu,17, Ecan
writeu,18, Tveg
writeu,19, Esol
