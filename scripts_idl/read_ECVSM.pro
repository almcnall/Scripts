...
;;this is to read and agregate the ECV 
;doh, I forgot 2000! oops. Dec2, 2013

indir = '/raid/chg-mcnally/ECV_soil_moisture/ESACCI-L3S_SOILMOISTURE-SSMV-MERGED/'
;ifile = file_search(indir+'20{01,02,03,04,05,06,07,08,09,10}/*nc')
ifile = file_search(indir+'2000/*nc')
