...
print, min(ingrid01), max(ingrid01)
...
p1 = image(reverse(VSM02_L0-Noah025_03, 2),rgb_table=74,image_dimensions=[nx*xsize,ny*ysize], image_location=[map_ulx,map_lry], $
...
p1.title = 'VIC_SM02 vs Noah_SM03_025'
;;;;;;;;;;;;;;
