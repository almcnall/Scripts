pro flip_AF_gs4r_wrsi,year,date,expdir,nx,ny,nbands
...
;updated on 11/04/2013 to post process the LIS-WRSI runs

wdir = strcompress("/raid/chg-mcnally/LISWRSI_OUTPUT/longrains/"+expdir+"/WRSI/"+year+"/"+date+"/",/remove_all)
...
deyuk=strcompress("/raid/chg-mcnally/LISWRSI_OUTPUT/postprocess/"+expdir+"/",/remove_all)
file_mkdir,deyuk
