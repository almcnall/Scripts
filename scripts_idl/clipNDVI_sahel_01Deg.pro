...
;ifile = file_search('/jabber/LIS/Data/ubRFE2/dekads/2012*.img')
ifile = file_search('/jabber/LIS/Data/ubRFE04.19.2013/dekads/2013*.img')
;ifile = file_search('/jabber/LIS/Data/CPCOriginalRFE2/dekads/2013*.img')
...
for f = 0,n_elements(ifile)-1 do begin &$
 ...
 ofile = strcompress('/jabber/LIS/Data/CPCOriginalRFE2/dekads/sahel/'+strmid(ifile[f],40,19), /remove_all) &$
 ;ofile = '/jabber/LIS/Data/ubRFE04.19.2013/dekads/sahel/'+strmid(ifile[f],40,19) &$
 ;ofile = '/jabber/LIS/Data/ubRFE2/dekads/sahel/update/'+strmid(ifile[f],31,19) &$
 ;ofile = strcompress('/jabber/sandbox/mcnally/BRHA1-FEWSNet/eMODIS/01degree/sahel/update/data.20'+strmid(ifile[f],61,19),/remove_all) &$
