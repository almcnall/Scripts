...
;the rainfall at different lags. Version one is for the soil neutron probe measurements associated
;with file 210-CE.Swsan_Nc.csv, where the dates are arbitrary. This Version 2.0 is for the volumetric 
;soil mosture measurments at one millet (13.644;2.6299) and one fallow (13.6476;2.6337)site. These two 
;sites do not match up with any of the neutron probe sites but still might be able to be used to calibrates them.
...
;sfile='/jabber/Data/mcnally/AMMASOIL/wankama_fallow_110dates.dat' ;this is different for fallow and millet!
sfile='/jabber/Data/mcnally/AMMASOIL/wankama_millet_110dates.dat' ;this is different for fallow and millet!
...
DOI=[185, 207, 211, 213, 221, 224, 234, 245, 253, 262, 263, 271, 323]
