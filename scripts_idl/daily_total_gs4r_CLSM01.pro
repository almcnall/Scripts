pro daily_total_gs4r_CLSM01,year,date,expdir,nx,ny,nbands
...
;flip_AF_gs4r_CLSM01,date,year,expdir,nx,ny,nbands ;does commenting this out go straight to deyuck?

close,/ALL

wdir = strcompress("/gibber/lis_data/OUTPUT/"+expdir+"/CLSM/"+year+"/"+date+"/deyuk/",/remove_all)
FILE_MKDIR,wdir
...
day_file = strcompress("/gibber/lis_data/OUTPUT/"+expdir+"/CLSM/daily/", /remove_all)
FILE_MKDIR,day_file
...
;of6 = strcompress(day_file+"Albd_" +date+".img",/remove_all)
;of7 = strcompress(day_file+"swee_" +date+".img",/remove_all)
;of8 = strcompress(day_file+"sndp_" +date+".img",/remove_all)
of9 = strcompress(day_file+"sm01_" +date+".img",/remove_all)
of10 = strcompress(day_file+"sm02_" +date+".img",/remove_all)
of11 = strcompress(day_file+"sm03_" +date+".img",/remove_all)
of12 = strcompress(day_file+"sm04_" +date+".img",/remove_all)
of13 = strcompress(day_file+"Ecan_" +date+".img",/remove_all)
of14 = strcompress(day_file+"TVeg_" +date+".img",/remove_all)
of15 = strcompress(day_file+"ESol_" +date+".img",/remove_all)
;of16 = strcompress(day_file+"rainf_" +date+".img",/remove_all)
of17 = strcompress(day_file+"tair_" +date+".img",/remove_all)
...
;Avg surf temp   data_in[x,y,6,*]
;Albedo          data_in[x,y,7,*]
;SWE             data_in[x,y,8,*]
;SWE             data_in[x,y,9,*]
sm01[x,y] = mean(data_in[x,y,10,*],/NAN)
sm02[x,y] = mean(data_in[x,y,11,*],/NAN)
sm03[x,y] = mean(data_in[x,y,12,*],/NAN)
Ecan[x,y] = mean(data_in[x,y,13,*],/NAN)
TVeg[x,y] = mean(data_in[x,y,14,*],/NAN)
ESol[x,y] = mean(data_in[x,y,15,*],/NAN) ;so I am missing this one...but TVeg should be 25% of evap
;rainf           data_in[x,y,16,*]
tair[x,y] = mean(data_in[x,y,17,*],/NAN) 
