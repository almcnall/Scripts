...
odir = strcompress('/jabber/sandbox/mcnally/VIC_runoff/binary/SubQ/', /remove_all)
file_mkdir, odir
cd, indir
...
;open the file
  ...
  runoffID = ncdf_varid(fileID,'BGRUN_GDS0_SFC_ave4h');I know the name from using some other functions, ncdump is prolly best
