...
;1/27/16 try to modify this script so i can write out necessary attributes for the LIS-generic netcdf reader
;
;
;	year		= 2012
;	last_month	=    2
...
;the stupid days-since-start filed
...
;name the output file. LDT_HISTYYYYMMDDHHMM.d01.nc
ifile = file_search('/home/RFE2/daily/all_products.bin.20120320')
