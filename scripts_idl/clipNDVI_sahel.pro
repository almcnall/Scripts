;the purpose of this script is to make the eMODIS files the same window 
...
;where did i get these from ENVI?
nx = 29838
ny = 31299

;double check to make sure that this matches the sahel window: 720x350 @ 0.1 degree -19W,52E,-5S,30N
outx = 19271
outy = 7874
