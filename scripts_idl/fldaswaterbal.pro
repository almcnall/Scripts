...
p1=plot(total(rainavg,/cumulative)*86400*30)
...
p1=plot(rainavg*86400)
p1=plot(evapavg*86400, /overplot, 'b')
p1=plot(ROavg*86400, /overplot, 'orange')
p1=plot(ROavg*86400+Evapavg*86400,/overplot,'-r')
