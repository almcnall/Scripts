pro EXP025_AET  ; indir, var ;add these when I understand how to run this from a script
...
mars=fltarr(mx,my,9);just keep it square...
...
for i=0,n_elements(fileE)-1 do begin
  ...
  index=where(MalAOI eq 0, count)
  MalAOI(index)=!VALUES.F_NAN
...
;p1=barplot(jancubie(1:8), thick=2) 
